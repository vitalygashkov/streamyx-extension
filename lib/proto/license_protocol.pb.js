...
export const LicenseIdentification = $root.LicenseIdentification = (() => {
    ...
    LicenseIdentification.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseIdentification();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    LicenseIdentification.fromObject = function fromObject(d) {
        if (d instanceof $root.LicenseIdentification)
            return d;
        var m = new $root.LicenseIdentification();
        if (d.requestId != null) {
            if (typeof d.requestId === "string")
                $util.base64.decode(d.requestId, m.requestId = $util.newBuffer($util.base64.length(d.requestId)), 0);
            else if (d.requestId.length >= 0)
                m.requestId = d.requestId;
        }
        if (d.sessionId != null) {
            if (typeof d.sessionId === "string")
                $util.base64.decode(d.sessionId, m.sessionId = $util.newBuffer($util.base64.length(d.sessionId)), 0);
            else if (d.sessionId.length >= 0)
                m.sessionId = d.sessionId;
        }
        if (d.purchaseId != null) {
            if (typeof d.purchaseId === "string")
                $util.base64.decode(d.purchaseId, m.purchaseId = $util.newBuffer($util.base64.length(d.purchaseId)), 0);
            else if (d.purchaseId.length >= 0)
                m.purchaseId = d.purchaseId;
        }
        switch (d.type) {
        default:
        ...
        if (d.providerSessionToken != null) {
            if (typeof d.providerSessionToken === "string")
                $util.base64.decode(d.providerSessionToken, m.providerSessionToken = $util.newBuffer($util.base64.length(d.providerSessionToken)), 0);
    ...
    LicenseIdentification.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            if (o.bytes === String)
                ...
                d.requestId = [];
                if (o.bytes !== Array)
                    d.requestId = $util.newBuffer(d.requestId);
            }
            if (o.bytes === String)
                d.sessionId = "";
            else {
                d.sessionId = [];
                if (o.bytes !== Array)
                    d.sessionId = $util.newBuffer(d.sessionId);
            }
            if (o.bytes === String)
                d.purchaseId = "";
            else {
                d.purchaseId = [];
                if (o.bytes !== Array)
                    d.purchaseId = $util.newBuffer(d.purchaseId);
            }
        ...
        if (m.type != null && m.hasOwnProperty("type")) {
            d.type = o.enums === String ? $root.LicenseType[m.type] === undefined ? m.type : $root.LicenseType[m.type] : m.type;
        }
        if (m.version != null && m.hasOwnProperty("version")) {
            d.version = m.version;
        }
        if (m.providerSessionToken != null && m.hasOwnProperty("providerSessionToken")) {
            d.providerSessionToken = o.bytes === String ? $util.base64.encode(m.providerSessionToken, 0, m.providerSessionToken.length) : o.bytes === Array ? Array.prototype.slice.call(m.providerSessionToken) : m.providerSessionToken;
        }
        return d;
    };
...
export const License = $root.License = (() => {
    ...
    License.encode = function encode(m, w) {
        ...
        if (m.key != null && m.key.length) {
            for (var i = 0; i < m.key.length; ++i)
                $root.License.KeyContainer.encode(m.key[i], w.uint32(26).fork()).ldelim();
        }
    ...
    License.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.License();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    License.fromObject = function fromObject(d) {
        ...
        if (d.licenseStartTime != null) {
            if ($util.Long)
                (m.licenseStartTime = $util.Long.fromValue(d.licenseStartTime)).unsigned = false;
                ...
                m.licenseStartTime = new $util.LongBits(d.licenseStartTime.low >>> 0, d.licenseStartTime.high >>> 0).toNumber();
        }
        ...
        if (d.providerClientToken != null) {
            if (typeof d.providerClientToken === "string")
                $util.base64.decode(d.providerClientToken, m.providerClientToken = $util.newBuffer($util.base64.length(d.providerClientToken)), 0);
        ...
        if (d.srmRequirement != null) {
            if (typeof d.srmRequirement === "string")
                $util.base64.decode(d.srmRequirement, m.srmRequirement = $util.newBuffer($util.base64.length(d.srmRequirement)), 0);
            else if (d.srmRequirement.length >= 0)
                m.srmRequirement = d.srmRequirement;
        }
        if (d.srmUpdate != null) {
            if (typeof d.srmUpdate === "string")
                $util.base64.decode(d.srmUpdate, m.srmUpdate = $util.newBuffer($util.base64.length(d.srmUpdate)), 0);
            else if (d.srmUpdate.length >= 0)
                m.srmUpdate = d.srmUpdate;
        }
        ...
        if (d.groupIds) {
            ...
            for (var i = 0; i < d.groupIds.length; ++i) {
                if (typeof d.groupIds[i] === "string")
                    $util.base64.decode(d.groupIds[i], m.groupIds[i] = $util.newBuffer($util.base64.length(d.groupIds[i])), 0);
                else if (d.groupIds[i].length >= 0)
                    m.groupIds[i] = d.groupIds[i];
            }
        }
        return m;
    };
    ...
    License.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if ($util.Long) {
                ...
                d.licenseStartTime = o.longs === String ? "0" : 0;
            ...
            if (o.bytes === String)
                ...
                d.srmUpdate = [];
                if (o.bytes !== Array)
                    d.srmUpdate = $util.newBuffer(d.srmUpdate);
            }
        ...
        if (m.licenseStartTime != null && m.hasOwnProperty("licenseStartTime")) {
            if (typeof m.licenseStartTime === "number")
                ...
                d.licenseStartTime = o.longs === String ? $util.Long.prototype.toString.call(m.licenseStartTime) : o.longs === Number ? new $util.LongBits(m.licenseStartTime.low >>> 0, m.licenseStartTime.high >>> 0).toNumber() : m.licenseStartTime;
        }
        ...
        if (m.providerClientToken != null && m.hasOwnProperty("providerClientToken")) {
            d.providerClientToken = o.bytes === String ? $util.base64.encode(m.providerClientToken, 0, m.providerClientToken.length) : o.bytes === Array ? Array.prototype.slice.call(m.providerClientToken) : m.providerClientToken;
        }
        ...
        if (m.platformVerificationStatus != null && m.hasOwnProperty("platformVerificationStatus")) {
            d.platformVerificationStatus = o.enums === String ? $root.PlatformVerificationStatus[m.platformVerificationStatus] === undefined ? m.platformVerificationStatus : $root.PlatformVerificationStatus[m.platformVerificationStatus] : m.platformVerificationStatus;
        }
        if (m.groupIds && m.groupIds.length) {
            d.groupIds = [];
    ...
    License.Policy = (function() {
        ...
        Policy.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.License.Policy();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        Policy.fromObject = function fromObject(d) {
            if (d instanceof $root.License.Policy)
                return d;
            ...
            if (d.rentalDurationSeconds != null) {
                if ($util.Long)
                    (m.rentalDurationSeconds = $util.Long.fromValue(d.rentalDurationSeconds)).unsigned = false;
                    ...
                    m.rentalDurationSeconds = new $util.LongBits(d.rentalDurationSeconds.low >>> 0, d.rentalDurationSeconds.high >>> 0).toNumber();
            }
            if (d.playbackDurationSeconds != null) {
                if ($util.Long)
                    (m.playbackDurationSeconds = $util.Long.fromValue(d.playbackDurationSeconds)).unsigned = false;
                    ...
                    m.playbackDurationSeconds = new $util.LongBits(d.playbackDurationSeconds.low >>> 0, d.playbackDurationSeconds.high >>> 0).toNumber();
            }
            if (d.licenseDurationSeconds != null) {
                if ($util.Long)
                    (m.licenseDurationSeconds = $util.Long.fromValue(d.licenseDurationSeconds)).unsigned = false;
                    ...
                    m.licenseDurationSeconds = new $util.LongBits(d.licenseDurationSeconds.low >>> 0, d.licenseDurationSeconds.high >>> 0).toNumber();
            }
            if (d.renewalRecoveryDurationSeconds != null) {
                if ($util.Long)
                    (m.renewalRecoveryDurationSeconds = $util.Long.fromValue(d.renewalRecoveryDurationSeconds)).unsigned = false;
                else if (typeof d.renewalRecoveryDurationSeconds === "string")
                    m.renewalRecoveryDurationSeconds = parseInt(d.renewalRecoveryDurationSeconds, 10);
                    ...
                    m.renewalRecoveryDurationSeconds = new $util.LongBits(d.renewalRecoveryDurationSeconds.low >>> 0, d.renewalRecoveryDurationSeconds.high >>> 0).toNumber();
            }
            ...
            if (d.renewalDelaySeconds != null) {
                if ($util.Long)
                    (m.renewalDelaySeconds = $util.Long.fromValue(d.renewalDelaySeconds)).unsigned = false;
                    ...
                    m.renewalDelaySeconds = new $util.LongBits(d.renewalDelaySeconds.low >>> 0, d.renewalDelaySeconds.high >>> 0).toNumber();
            }
            if (d.renewalRetryIntervalSeconds != null) {
                if ($util.Long)
                    (m.renewalRetryIntervalSeconds = $util.Long.fromValue(d.renewalRetryIntervalSeconds)).unsigned = false;
                else if (typeof d.renewalRetryIntervalSeconds === "string")
                    m.renewalRetryIntervalSeconds = parseInt(d.renewalRetryIntervalSeconds, 10);
                    ...
                    m.renewalRetryIntervalSeconds = new $util.LongBits(d.renewalRetryIntervalSeconds.low >>> 0, d.renewalRetryIntervalSeconds.high >>> 0).toNumber();
            }
            ...
            if (d.playStartGracePeriodSeconds != null) {
                if ($util.Long)
                    (m.playStartGracePeriodSeconds = $util.Long.fromValue(d.playStartGracePeriodSeconds)).unsigned = false;
                else if (typeof d.playStartGracePeriodSeconds === "string")
                    m.playStartGracePeriodSeconds = parseInt(d.playStartGracePeriodSeconds, 10);
                    ...
                    m.playStartGracePeriodSeconds = new $util.LongBits(d.playStartGracePeriodSeconds.low >>> 0, d.playStartGracePeriodSeconds.high >>> 0).toNumber();
            }
        ...
        Policy.toObject = function toObject(m, o) {
            ...
            if (o.defaults) {
                ...
                if ($util.Long) {
                    ...
                    d.playStartGracePeriodSeconds = o.longs === String ? "0" : 0;
            ...
            if (m.rentalDurationSeconds != null && m.hasOwnProperty("rentalDurationSeconds")) {
                if (typeof m.rentalDurationSeconds === "number")
                    ...
                    d.rentalDurationSeconds = o.longs === String ? $util.Long.prototype.toString.call(m.rentalDurationSeconds) : o.longs === Number ? new $util.LongBits(m.rentalDurationSeconds.low >>> 0, m.rentalDurationSeconds.high >>> 0).toNumber() : m.rentalDurationSeconds;
            }
            if (m.playbackDurationSeconds != null && m.hasOwnProperty("playbackDurationSeconds")) {
                if (typeof m.playbackDurationSeconds === "number")
                    ...
                    d.playbackDurationSeconds = o.longs === String ? $util.Long.prototype.toString.call(m.playbackDurationSeconds) : o.longs === Number ? new $util.LongBits(m.playbackDurationSeconds.low >>> 0, m.playbackDurationSeconds.high >>> 0).toNumber() : m.playbackDurationSeconds;
            }
            if (m.licenseDurationSeconds != null && m.hasOwnProperty("licenseDurationSeconds")) {
                if (typeof m.licenseDurationSeconds === "number")
                    ...
                    d.licenseDurationSeconds = o.longs === String ? $util.Long.prototype.toString.call(m.licenseDurationSeconds) : o.longs === Number ? new $util.LongBits(m.licenseDurationSeconds.low >>> 0, m.licenseDurationSeconds.high >>> 0).toNumber() : m.licenseDurationSeconds;
            }
            if (m.renewalRecoveryDurationSeconds != null && m.hasOwnProperty("renewalRecoveryDurationSeconds")) {
                if (typeof m.renewalRecoveryDurationSeconds === "number")
                    ...
                    d.renewalRecoveryDurationSeconds = o.longs === String ? $util.Long.prototype.toString.call(m.renewalRecoveryDurationSeconds) : o.longs === Number ? new $util.LongBits(m.renewalRecoveryDurationSeconds.low >>> 0, m.renewalRecoveryDurationSeconds.high >>> 0).toNumber() : m.renewalRecoveryDurationSeconds;
            }
            ...
            if (m.renewalDelaySeconds != null && m.hasOwnProperty("renewalDelaySeconds")) {
                if (typeof m.renewalDelaySeconds === "number")
                    ...
                    d.renewalDelaySeconds = o.longs === String ? $util.Long.prototype.toString.call(m.renewalDelaySeconds) : o.longs === Number ? new $util.LongBits(m.renewalDelaySeconds.low >>> 0, m.renewalDelaySeconds.high >>> 0).toNumber() : m.renewalDelaySeconds;
            }
            if (m.renewalRetryIntervalSeconds != null && m.hasOwnProperty("renewalRetryIntervalSeconds")) {
                if (typeof m.renewalRetryIntervalSeconds === "number")
                    ...
                    d.renewalRetryIntervalSeconds = o.longs === String ? $util.Long.prototype.toString.call(m.renewalRetryIntervalSeconds) : o.longs === Number ? new $util.LongBits(m.renewalRetryIntervalSeconds.low >>> 0, m.renewalRetryIntervalSeconds.high >>> 0).toNumber() : m.renewalRetryIntervalSeconds;
            }
            ...
            if (m.playStartGracePeriodSeconds != null && m.hasOwnProperty("playStartGracePeriodSeconds")) {
                if (typeof m.playStartGracePeriodSeconds === "number")
                    ...
                    d.playStartGracePeriodSeconds = o.longs === String ? $util.Long.prototype.toString.call(m.playStartGracePeriodSeconds) : o.longs === Number ? new $util.LongBits(m.playStartGracePeriodSeconds.low >>> 0, m.playStartGracePeriodSeconds.high >>> 0).toNumber() : m.playStartGracePeriodSeconds;
            }
    ...
    License.KeyContainer = (function() {
        ...
        KeyContainer.encode = function encode(m, w) {
            ...
            if (m.requiredProtection != null && Object.hasOwnProperty.call(m, "requiredProtection"))
                $root.License.KeyContainer.OutputProtection.encode(m.requiredProtection, w.uint32(50).fork()).ldelim();
            if (m.requestedProtection != null && Object.hasOwnProperty.call(m, "requestedProtection"))
                $root.License.KeyContainer.OutputProtection.encode(m.requestedProtection, w.uint32(58).fork()).ldelim();
            if (m.keyControl != null && Object.hasOwnProperty.call(m, "keyControl"))
                $root.License.KeyContainer.KeyControl.encode(m.keyControl, w.uint32(66).fork()).ldelim();
            if (m.operatorSessionKeyPermissions != null && Object.hasOwnProperty.call(m, "operatorSessionKeyPermissions"))
                $root.License.KeyContainer.OperatorSessionKeyPermissions.encode(m.operatorSessionKeyPermissions, w.uint32(74).fork()).ldelim();
            if (m.videoResolutionConstraints != null && m.videoResolutionConstraints.length) {
                for (var i = 0; i < m.videoResolutionConstraints.length; ++i)
                    $root.License.KeyContainer.VideoResolutionConstraint.encode(m.videoResolutionConstraints[i], w.uint32(82).fork()).ldelim();
            }
        ...
        KeyContainer.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.License.KeyContainer();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
                ...
                case 8: {
                        m.keyControl = $root.License.KeyContainer.KeyControl.decode(r, r.uint32());
                        break;
                    }
                case 9: {
                        m.operatorSessionKeyPermissions = $root.License.KeyContainer.OperatorSessionKeyPermissions.decode(r, r.uint32());
                        break;
                    }
                case 10: {
                        if (!(m.videoResolutionConstraints && m.videoResolutionConstraints.length))
                            m.videoResolutionConstraints = [];
                        m.videoResolutionConstraints.push($root.License.KeyContainer.VideoResolutionConstraint.decode(r, r.uint32()));
                        break;
                    }
                case 11: {
        ...
        KeyContainer.fromObject = function fromObject(d) {
            if (d instanceof $root.License.KeyContainer)
                return d;
            ...
            if (d.requiredProtection != null) {
                ...
                m.requiredProtection = $root.License.KeyContainer.OutputProtection.fromObject(d.requiredProtection);
            }
            if (d.requestedProtection != null) {
                ...
                m.requestedProtection = $root.License.KeyContainer.OutputProtection.fromObject(d.requestedProtection);
            }
            if (d.keyControl != null) {
                if (typeof d.keyControl !== "object")
                    throw TypeError(".License.KeyContainer.keyControl: object expected");
                m.keyControl = $root.License.KeyContainer.KeyControl.fromObject(d.keyControl);
            }
            if (d.operatorSessionKeyPermissions != null) {
                ...
                m.operatorSessionKeyPermissions = $root.License.KeyContainer.OperatorSessionKeyPermissions.fromObject(d.operatorSessionKeyPermissions);
            }
            if (d.videoResolutionConstraints) {
                ...
                for (var i = 0; i < d.videoResolutionConstraints.length; ++i) {
                    ...
                    m.videoResolutionConstraints[i] = $root.License.KeyContainer.VideoResolutionConstraint.fromObject(d.videoResolutionConstraints[i]);
                }
            }
        ...
        KeyContainer.toObject = function toObject(m, o) {
            ...
            if (m.type != null && m.hasOwnProperty("type")) {
                d.type = o.enums === String ? $root.License.KeyContainer.KeyType[m.type] === undefined ? m.type : $root.License.KeyContainer.KeyType[m.type] : m.type;
            }
            if (m.level != null && m.hasOwnProperty("level")) {
                d.level = o.enums === String ? $root.License.KeyContainer.SecurityLevel[m.level] === undefined ? m.level : $root.License.KeyContainer.SecurityLevel[m.level] : m.level;
            }
            if (m.requiredProtection != null && m.hasOwnProperty("requiredProtection")) {
                d.requiredProtection = $root.License.KeyContainer.OutputProtection.toObject(m.requiredProtection, o);
            }
            if (m.requestedProtection != null && m.hasOwnProperty("requestedProtection")) {
                d.requestedProtection = $root.License.KeyContainer.OutputProtection.toObject(m.requestedProtection, o);
            }
            if (m.keyControl != null && m.hasOwnProperty("keyControl")) {
                d.keyControl = $root.License.KeyContainer.KeyControl.toObject(m.keyControl, o);
            }
            if (m.operatorSessionKeyPermissions != null && m.hasOwnProperty("operatorSessionKeyPermissions")) {
                d.operatorSessionKeyPermissions = $root.License.KeyContainer.OperatorSessionKeyPermissions.toObject(m.operatorSessionKeyPermissions, o);
            }
            if (m.videoResolutionConstraints && m.videoResolutionConstraints.length) {
                d.videoResolutionConstraints = [];
                for (var j = 0; j < m.videoResolutionConstraints.length; ++j) {
                    d.videoResolutionConstraints[j] = $root.License.KeyContainer.VideoResolutionConstraint.toObject(m.videoResolutionConstraints[j], o);
                }
            }
        ...
        KeyContainer.KeyControl = (function() {
            ...
            KeyControl.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.License.KeyContainer.KeyControl();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
            ...
            KeyControl.fromObject = function fromObject(d) {
                if (d instanceof $root.License.KeyContainer.KeyControl)
                    return d;
                var m = new $root.License.KeyContainer.KeyControl();
                if (d.keyControlBlock != null) {
                    if (typeof d.keyControlBlock === "string")
                        $util.base64.decode(d.keyControlBlock, m.keyControlBlock = $util.newBuffer($util.base64.length(d.keyControlBlock)), 0);
            ...
            KeyControl.toObject = function toObject(m, o) {
                ...
                if (m.keyControlBlock != null && m.hasOwnProperty("keyControlBlock")) {
                    d.keyControlBlock = o.bytes === String ? $util.base64.encode(m.keyControlBlock, 0, m.keyControlBlock.length) : o.bytes === Array ? Array.prototype.slice.call(m.keyControlBlock) : m.keyControlBlock;
                }
                if (m.iv != null && m.hasOwnProperty("iv")) {
                    d.iv = o.bytes === String ? $util.base64.encode(m.iv, 0, m.iv.length) : o.bytes === Array ? Array.prototype.slice.call(m.iv) : m.iv;
                }
        ...
        KeyContainer.OutputProtection = (function() {
            ...
            OutputProtection.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.License.KeyContainer.OutputProtection();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
            ...
            OutputProtection.fromObject = function fromObject(d) {
                if (d instanceof $root.License.KeyContainer.OutputProtection)
                    return d;
            ...
            OutputProtection.toObject = function toObject(m, o) {
                ...
                if (m.hdcp != null && m.hasOwnProperty("hdcp")) {
                    d.hdcp = o.enums === String ? $root.License.KeyContainer.OutputProtection.HDCP[m.hdcp] === undefined ? m.hdcp : $root.License.KeyContainer.OutputProtection.HDCP[m.hdcp] : m.hdcp;
                }
                if (m.cgmsFlags != null && m.hasOwnProperty("cgmsFlags")) {
                    d.cgmsFlags = o.enums === String ? $root.License.KeyContainer.OutputProtection.CGMS[m.cgmsFlags] === undefined ? m.cgmsFlags : $root.License.KeyContainer.OutputProtection.CGMS[m.cgmsFlags] : m.cgmsFlags;
                }
                if (m.hdcpSrmRule != null && m.hasOwnProperty("hdcpSrmRule")) {
                    d.hdcpSrmRule = o.enums === String ? $root.License.KeyContainer.OutputProtection.HdcpSrmRule[m.hdcpSrmRule] === undefined ? m.hdcpSrmRule : $root.License.KeyContainer.OutputProtection.HdcpSrmRule[m.hdcpSrmRule] : m.hdcpSrmRule;
                }
        ...
        KeyContainer.VideoResolutionConstraint = (function() {
            ...
            VideoResolutionConstraint.encode = function encode(m, w) {
                ...
                if (m.requiredProtection != null && Object.hasOwnProperty.call(m, "requiredProtection"))
                    $root.License.KeyContainer.OutputProtection.encode(m.requiredProtection, w.uint32(26).fork()).ldelim();
                return w;
            };
            ...
            VideoResolutionConstraint.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.License.KeyContainer.VideoResolutionConstraint();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
        ...
        KeyContainer.OperatorSessionKeyPermissions = (function() {
            ...
            OperatorSessionKeyPermissions.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.License.KeyContainer.OperatorSessionKeyPermissions();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
...
export const LicenseRequest = $root.LicenseRequest = (() => {
    ...
    LicenseRequest.encode = function encode(m, w) {
        ...
        if (m.clientId != null && Object.hasOwnProperty.call(m, "clientId"))
            $root.ClientIdentification.encode(m.clientId, w.uint32(10).fork()).ldelim();
        if (m.contentId != null && Object.hasOwnProperty.call(m, "contentId"))
            $root.LicenseRequest.ContentIdentification.encode(m.contentId, w.uint32(18).fork()).ldelim();
        if (m.type != null && Object.hasOwnProperty.call(m, "type"))
        ...
        if (m.encryptedClientId != null && Object.hasOwnProperty.call(m, "encryptedClientId"))
            $root.EncryptedClientIdentification.encode(m.encryptedClientId, w.uint32(66).fork()).ldelim();
        return w;
    };
    ...
    LicenseRequest.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseRequest();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
            ...
            case 2: {
                    m.contentId = $root.LicenseRequest.ContentIdentification.decode(r, r.uint32());
                    break;
                }
            case 3: {
                    m.type = r.int32();
            ...
            case 8: {
                    m.encryptedClientId = $root.EncryptedClientIdentification.decode(r, r.uint32());
                    break;
                }
            default:
                r.skipType(t & 7);
    ...
    LicenseRequest.fromObject = function fromObject(d) {
        if (d instanceof $root.LicenseRequest)
            return d;
        ...
        if (d.contentId != null) {
            ...
            m.contentId = $root.LicenseRequest.ContentIdentification.fromObject(d.contentId);
        }
        switch (d.type) {
        default:
            if (typeof d.type === "number") {
        ...
        if (d.requestTime != null) {
            ...
            else if (typeof d.requestTime === "number")
                m.requestTime = d.requestTime;
            else if (typeof d.requestTime === "object")
                m.requestTime = new $util.LongBits(d.requestTime.low >>> 0, d.requestTime.high >>> 0).toNumber();
        }
        if (d.keyControlNonceDeprecated != null) {
            if (typeof d.keyControlNonceDeprecated === "string")
                $util.base64.decode(d.keyControlNonceDeprecated, m.keyControlNonceDeprecated = $util.newBuffer($util.base64.length(d.keyControlNonceDeprecated)), 0);
        ...
        if (d.encryptedClientId != null) {
            ...
            m.encryptedClientId = $root.EncryptedClientIdentification.fromObject(d.encryptedClientId);
        }
        return m;
    };
    ...
    LicenseRequest.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if ($util.Long) {
                ...
                d.requestTime = o.longs === String ? "0" : 0;
            if (o.bytes === String)
                d.keyControlNonceDeprecated = "";
            else {
                d.keyControlNonceDeprecated = [];
                if (o.bytes !== Array)
                    d.keyControlNonceDeprecated = $util.newBuffer(d.keyControlNonceDeprecated);
            }
        ...
        if (m.contentId != null && m.hasOwnProperty("contentId")) {
            d.contentId = $root.LicenseRequest.ContentIdentification.toObject(m.contentId, o);
        }
        if (m.type != null && m.hasOwnProperty("type")) {
            d.type = o.enums === String ? $root.LicenseRequest.RequestType[m.type] === undefined ? m.type : $root.LicenseRequest.RequestType[m.type] : m.type;
        }
        if (m.requestTime != null && m.hasOwnProperty("requestTime")) {
            if (typeof m.requestTime === "number")
                ...
                d.requestTime = o.longs === String ? $util.Long.prototype.toString.call(m.requestTime) : o.longs === Number ? new $util.LongBits(m.requestTime.low >>> 0, m.requestTime.high >>> 0).toNumber() : m.requestTime;
        }
        if (m.keyControlNonceDeprecated != null && m.hasOwnProperty("keyControlNonceDeprecated")) {
            d.keyControlNonceDeprecated = o.bytes === String ? $util.base64.encode(m.keyControlNonceDeprecated, 0, m.keyControlNonceDeprecated.length) : o.bytes === Array ? Array.prototype.slice.call(m.keyControlNonceDeprecated) : m.keyControlNonceDeprecated;
        }
        if (m.protocolVersion != null && m.hasOwnProperty("protocolVersion")) {
            d.protocolVersion = o.enums === String ? $root.ProtocolVersion[m.protocolVersion] === undefined ? m.protocolVersion : $root.ProtocolVersion[m.protocolVersion] : m.protocolVersion;
        }
        ...
        if (m.encryptedClientId != null && m.hasOwnProperty("encryptedClientId")) {
            d.encryptedClientId = $root.EncryptedClientIdentification.toObject(m.encryptedClientId, o);
        }
        return d;
    };
    ...
    LicenseRequest.ContentIdentification = (function() {
        ...
        ContentIdentification.encode = function encode(m, w) {
            ...
            if (m.widevinePsshData != null && Object.hasOwnProperty.call(m, "widevinePsshData"))
                $root.LicenseRequest.ContentIdentification.WidevinePsshData.encode(m.widevinePsshData, w.uint32(10).fork()).ldelim();
            if (m.webmKeyId != null && Object.hasOwnProperty.call(m, "webmKeyId"))
                $root.LicenseRequest.ContentIdentification.WebmKeyId.encode(m.webmKeyId, w.uint32(18).fork()).ldelim();
            if (m.existingLicense != null && Object.hasOwnProperty.call(m, "existingLicense"))
                $root.LicenseRequest.ContentIdentification.ExistingLicense.encode(m.existingLicense, w.uint32(26).fork()).ldelim();
            if (m.initData != null && Object.hasOwnProperty.call(m, "initData"))
                $root.LicenseRequest.ContentIdentification.InitData.encode(m.initData, w.uint32(34).fork()).ldelim();
            return w;
        };
        ...
        ContentIdentification.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseRequest.ContentIdentification();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
                        m.widevinePsshData = $root.LicenseRequest.ContentIdentification.WidevinePsshData.decode(r, r.uint32());
                        break;
                    }
                case 2: {
                        m.webmKeyId = $root.LicenseRequest.ContentIdentification.WebmKeyId.decode(r, r.uint32());
                        break;
                    }
                case 3: {
                        m.existingLicense = $root.LicenseRequest.ContentIdentification.ExistingLicense.decode(r, r.uint32());
                        break;
                    }
                case 4: {
                        m.initData = $root.LicenseRequest.ContentIdentification.InitData.decode(r, r.uint32());
                        break;
                    }
                default:
                    r.skipType(t & 7);
        ...
        ContentIdentification.fromObject = function fromObject(d) {
            if (d instanceof $root.LicenseRequest.ContentIdentification)
                return d;
            ...
            if (d.widevinePsshData != null) {
                ...
                m.widevinePsshData = $root.LicenseRequest.ContentIdentification.WidevinePsshData.fromObject(d.widevinePsshData);
            }
            if (d.webmKeyId != null) {
                if (typeof d.webmKeyId !== "object")
                    throw TypeError(".LicenseRequest.ContentIdentification.webmKeyId: object expected");
                m.webmKeyId = $root.LicenseRequest.ContentIdentification.WebmKeyId.fromObject(d.webmKeyId);
            }
            if (d.existingLicense != null) {
                ...
                m.existingLicense = $root.LicenseRequest.ContentIdentification.ExistingLicense.fromObject(d.existingLicense);
            }
            if (d.initData != null) {
                if (typeof d.initData !== "object")
                    throw TypeError(".LicenseRequest.ContentIdentification.initData: object expected");
                m.initData = $root.LicenseRequest.ContentIdentification.InitData.fromObject(d.initData);
            }
            return m;
        };
        ...
        ContentIdentification.toObject = function toObject(m, o) {
            ...
            if (m.widevinePsshData != null && m.hasOwnProperty("widevinePsshData")) {
                d.widevinePsshData = $root.LicenseRequest.ContentIdentification.WidevinePsshData.toObject(m.widevinePsshData, o);
                if (o.oneofs)
                    d.contentIdVariant = "widevinePsshData";
            }
            if (m.webmKeyId != null && m.hasOwnProperty("webmKeyId")) {
                d.webmKeyId = $root.LicenseRequest.ContentIdentification.WebmKeyId.toObject(m.webmKeyId, o);
                if (o.oneofs)
                    d.contentIdVariant = "webmKeyId";
            }
            if (m.existingLicense != null && m.hasOwnProperty("existingLicense")) {
                d.existingLicense = $root.LicenseRequest.ContentIdentification.ExistingLicense.toObject(m.existingLicense, o);
                if (o.oneofs)
                    d.contentIdVariant = "existingLicense";
            }
            if (m.initData != null && m.hasOwnProperty("initData")) {
                d.initData = $root.LicenseRequest.ContentIdentification.InitData.toObject(m.initData, o);
                if (o.oneofs)
                    d.contentIdVariant = "initData";
            }
            return d;
        };
        ...
        ContentIdentification.WidevinePsshData = (function() {
            ...
            WidevinePsshData.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseRequest.ContentIdentification.WidevinePsshData();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
                ...
                if (d.psshData) {
                    ...
                    for (var i = 0; i < d.psshData.length; ++i) {
                        if (typeof d.psshData[i] === "string")
                            $util.base64.decode(d.psshData[i], m.psshData[i] = $util.newBuffer($util.base64.length(d.psshData[i])), 0);
                        else if (d.psshData[i].length >= 0)
                            m.psshData[i] = d.psshData[i];
                    }
                }
            ...
            WidevinePsshData.toObject = function toObject(m, o) {
                ...
                if (m.licenseType != null && m.hasOwnProperty("licenseType")) {
                    d.licenseType = o.enums === String ? $root.LicenseType[m.licenseType] === undefined ? m.licenseType : $root.LicenseType[m.licenseType] : m.licenseType;
                }
                if (m.requestId != null && m.hasOwnProperty("requestId")) {
                    d.requestId = o.bytes === String ? $util.base64.encode(m.requestId, 0, m.requestId.length) : o.bytes === Array ? Array.prototype.slice.call(m.requestId) : m.requestId;
                }
        ...
        ContentIdentification.WebmKeyId = (function() {
            ...
            WebmKeyId.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseRequest.ContentIdentification.WebmKeyId();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
        ...
        ContentIdentification.ExistingLicense = (function() {
            ...
            ExistingLicense.encode = function encode(m, w) {
                ...
                if (m.licenseId != null && Object.hasOwnProperty.call(m, "licenseId"))
                    $root.LicenseIdentification.encode(m.licenseId, w.uint32(10).fork()).ldelim();
            ...
            ExistingLicense.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseRequest.ContentIdentification.ExistingLicense();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
            ...
            ExistingLicense.fromObject = function fromObject(d) {
                ...
                if (d.secondsSinceStarted != null) {
                    if ($util.Long)
                        (m.secondsSinceStarted = $util.Long.fromValue(d.secondsSinceStarted)).unsigned = false;
                        ...
                        m.secondsSinceStarted = new $util.LongBits(d.secondsSinceStarted.low >>> 0, d.secondsSinceStarted.high >>> 0).toNumber();
                }
                if (d.secondsSinceLastPlayed != null) {
                    if ($util.Long)
                        (m.secondsSinceLastPlayed = $util.Long.fromValue(d.secondsSinceLastPlayed)).unsigned = false;
                        ...
                        m.secondsSinceLastPlayed = new $util.LongBits(d.secondsSinceLastPlayed.low >>> 0, d.secondsSinceLastPlayed.high >>> 0).toNumber();
                }
                if (d.sessionUsageTableEntry != null) {
                    if (typeof d.sessionUsageTableEntry === "string")
                        $util.base64.decode(d.sessionUsageTableEntry, m.sessionUsageTableEntry = $util.newBuffer($util.base64.length(d.sessionUsageTableEntry)), 0);
            ...
            ExistingLicense.toObject = function toObject(m, o) {
                ...
                if (o.defaults) {
                    ...
                    if ($util.Long) {
                        ...
                        d.secondsSinceStarted = o.longs === String ? "0" : 0;
                    if ($util.Long) {
                        var n = new $util.Long(0, 0, false);
                        d.secondsSinceLastPlayed = o.longs === String ? n.toString() : o.longs === Number ? n.toNumber() : n;
                    } else
                        d.secondsSinceLastPlayed = o.longs === String ? "0" : 0;
                    if (o.bytes === String)
                        d.sessionUsageTableEntry = "";
                    else {
                        d.sessionUsageTableEntry = [];
                        if (o.bytes !== Array)
                            d.sessionUsageTableEntry = $util.newBuffer(d.sessionUsageTableEntry);
                    }
                }
                ...
                if (m.secondsSinceStarted != null && m.hasOwnProperty("secondsSinceStarted")) {
                    if (typeof m.secondsSinceStarted === "number")
                        ...
                        d.secondsSinceStarted = o.longs === String ? $util.Long.prototype.toString.call(m.secondsSinceStarted) : o.longs === Number ? new $util.LongBits(m.secondsSinceStarted.low >>> 0, m.secondsSinceStarted.high >>> 0).toNumber() : m.secondsSinceStarted;
                }
                if (m.secondsSinceLastPlayed != null && m.hasOwnProperty("secondsSinceLastPlayed")) {
                    if (typeof m.secondsSinceLastPlayed === "number")
                        ...
                        d.secondsSinceLastPlayed = o.longs === String ? $util.Long.prototype.toString.call(m.secondsSinceLastPlayed) : o.longs === Number ? new $util.LongBits(m.secondsSinceLastPlayed.low >>> 0, m.secondsSinceLastPlayed.high >>> 0).toNumber() : m.secondsSinceLastPlayed;
                }
                if (m.sessionUsageTableEntry != null && m.hasOwnProperty("sessionUsageTableEntry")) {
                    d.sessionUsageTableEntry = o.bytes === String ? $util.base64.encode(m.sessionUsageTableEntry, 0, m.sessionUsageTableEntry.length) : o.bytes === Array ? Array.prototype.slice.call(m.sessionUsageTableEntry) : m.sessionUsageTableEntry;
                }
                return d;
            };
        ...
        ContentIdentification.InitData = (function() {
            ...
            InitData.decode = function decode(r, l) {
                if (!(r instanceof $Reader))
                    r = $Reader.create(r);
                var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseRequest.ContentIdentification.InitData();
                while (r.pos < c) {
                    var t = r.uint32();
                    switch (t >>> 3) {
                    case 1: {
            ...
            InitData.fromObject = function fromObject(d) {
                ...
                if (d.initData != null) {
                    if (typeof d.initData === "string")
                        $util.base64.decode(d.initData, m.initData = $util.newBuffer($util.base64.length(d.initData)), 0);
                    else if (d.initData.length >= 0)
                        m.initData = d.initData;
                }
                switch (d.licenseType) {
                default:
                    if (typeof d.licenseType === "number") {
            ...
            InitData.toObject = function toObject(m, o) {
                ...
                if (o.defaults) {
                    ...
                    if (o.bytes === String)
                        ...
                        d.initData = [];
                        if (o.bytes !== Array)
                            d.initData = $util.newBuffer(d.initData);
                    }
                    d.licenseType = o.enums === String ? "STREAMING" : 1;
                    if (o.bytes === String)
                        d.requestId = "";
                ...
                if (m.initDataType != null && m.hasOwnProperty("initDataType")) {
                    d.initDataType = o.enums === String ? $root.LicenseRequest.ContentIdentification.InitData.InitDataType[m.initDataType] === undefined ? m.initDataType : $root.LicenseRequest.ContentIdentification.InitData.InitDataType[m.initDataType] : m.initDataType;
                }
                if (m.initData != null && m.hasOwnProperty("initData")) {
...
export const MetricData = $root.MetricData = (() => {
    ...
    MetricData.encode = function encode(m, w) {
        ...
        if (m.metricData != null && m.metricData.length) {
            for (var i = 0; i < m.metricData.length; ++i)
                $root.MetricData.TypeValue.encode(m.metricData[i], w.uint32(18).fork()).ldelim();
        }
        return w;
    };
    ...
    MetricData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.MetricData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    MetricData.fromObject = function fromObject(d) {
        if (d instanceof $root.MetricData)
            return d;
        ...
        if (d.metricData) {
            ...
            for (var i = 0; i < d.metricData.length; ++i) {
                ...
                m.metricData[i] = $root.MetricData.TypeValue.fromObject(d.metricData[i]);
            }
        }
        return m;
    };
    ...
    MetricData.toObject = function toObject(m, o) {
        ...
        if (m.metricData && m.metricData.length) {
            ...
            for (var j = 0; j < m.metricData.length; ++j) {
                d.metricData[j] = $root.MetricData.TypeValue.toObject(m.metricData[j], o);
            }
        }
        return d;
    };
    ...
    MetricData.TypeValue = (function() {
        ...
        TypeValue.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.MetricData.TypeValue();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        TypeValue.fromObject = function fromObject(d) {
            if (d instanceof $root.MetricData.TypeValue)
                return d;
        ...
        TypeValue.toObject = function toObject(m, o) {
            ...
            if (m.type != null && m.hasOwnProperty("type")) {
                d.type = o.enums === String ? $root.MetricData.MetricType[m.type] === undefined ? m.type : $root.MetricData.MetricType[m.type] : m.type;
            }
...
export const VersionInfo = $root.VersionInfo = (() => {
    ...
    VersionInfo.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.VersionInfo();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    VersionInfo.fromObject = function fromObject(d) {
        if (d instanceof $root.VersionInfo)
            return d;
...
export const SignedMessage = $root.SignedMessage = (() => {
    ...
    SignedMessage.encode = function encode(m, w) {
        ...
        if (m.serviceVersionInfo != null && Object.hasOwnProperty.call(m, "serviceVersionInfo"))
            $root.VersionInfo.encode(m.serviceVersionInfo, w.uint32(58).fork()).ldelim();
    ...
    SignedMessage.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.SignedMessage();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    SignedMessage.fromObject = function fromObject(d) {
        if (d instanceof $root.SignedMessage)
            return d;
        ...
        if (d.sessionKey != null) {
            if (typeof d.sessionKey === "string")
                $util.base64.decode(d.sessionKey, m.sessionKey = $util.newBuffer($util.base64.length(d.sessionKey)), 0);
            else if (d.sessionKey.length >= 0)
                m.sessionKey = d.sessionKey;
        }
        if (d.remoteAttestation != null) {
            if (typeof d.remoteAttestation === "string")
                $util.base64.decode(d.remoteAttestation, m.remoteAttestation = $util.newBuffer($util.base64.length(d.remoteAttestation)), 0);
        ...
        if (d.oemcryptoCoreMessage != null) {
            if (typeof d.oemcryptoCoreMessage === "string")
                $util.base64.decode(d.oemcryptoCoreMessage, m.oemcryptoCoreMessage = $util.newBuffer($util.base64.length(d.oemcryptoCoreMessage)), 0);
    ...
    SignedMessage.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if (o.bytes === String)
                ...
                d.sessionKey = [];
                if (o.bytes !== Array)
                    d.sessionKey = $util.newBuffer(d.sessionKey);
            }
            if (o.bytes === String)
                d.remoteAttestation = "";
            else {
        ...
        if (m.type != null && m.hasOwnProperty("type")) {
            d.type = o.enums === String ? $root.SignedMessage.MessageType[m.type] === undefined ? m.type : $root.SignedMessage.MessageType[m.type] : m.type;
        }
        ...
        if (m.remoteAttestation != null && m.hasOwnProperty("remoteAttestation")) {
            d.remoteAttestation = o.bytes === String ? $util.base64.encode(m.remoteAttestation, 0, m.remoteAttestation.length) : o.bytes === Array ? Array.prototype.slice.call(m.remoteAttestation) : m.remoteAttestation;
        }
        if (m.metricData && m.metricData.length) {
            d.metricData = [];
            for (var j = 0; j < m.metricData.length; ++j) {
        ...
        if (m.serviceVersionInfo != null && m.hasOwnProperty("serviceVersionInfo")) {
            d.serviceVersionInfo = $root.VersionInfo.toObject(m.serviceVersionInfo, o);
        }
        if (m.sessionKeyType != null && m.hasOwnProperty("sessionKeyType")) {
            d.sessionKeyType = o.enums === String ? $root.SignedMessage.SessionKeyType[m.sessionKeyType] === undefined ? m.sessionKeyType : $root.SignedMessage.SessionKeyType[m.sessionKeyType] : m.sessionKeyType;
        }
        if (m.oemcryptoCoreMessage != null && m.hasOwnProperty("oemcryptoCoreMessage")) {
            d.oemcryptoCoreMessage = o.bytes === String ? $util.base64.encode(m.oemcryptoCoreMessage, 0, m.oemcryptoCoreMessage.length) : o.bytes === Array ? Array.prototype.slice.call(m.oemcryptoCoreMessage) : m.oemcryptoCoreMessage;
        }
        return d;
    };
...
export const ClientIdentification = $root.ClientIdentification = (() => {
    ...
    ClientIdentification.encode = function encode(m, w) {
        ...
        if (m.clientInfo != null && m.clientInfo.length) {
            for (var i = 0; i < m.clientInfo.length; ++i)
                $root.ClientIdentification.NameValue.encode(m.clientInfo[i], w.uint32(26).fork()).ldelim();
        }
        if (m.providerClientToken != null && Object.hasOwnProperty.call(m, "providerClientToken"))
        ...
        if (m.clientCapabilities != null && Object.hasOwnProperty.call(m, "clientCapabilities"))
            $root.ClientIdentification.ClientCapabilities.encode(m.clientCapabilities, w.uint32(50).fork()).ldelim();
        ...
        if (m.deviceCredentials != null && m.deviceCredentials.length) {
            for (var i = 0; i < m.deviceCredentials.length; ++i)
                $root.ClientIdentification.ClientCredentials.encode(m.deviceCredentials[i], w.uint32(66).fork()).ldelim();
        }
        return w;
    };
    ...
    ClientIdentification.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.ClientIdentification();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
            ...
            case 3: {
                    if (!(m.clientInfo && m.clientInfo.length))
                        m.clientInfo = [];
                    m.clientInfo.push($root.ClientIdentification.NameValue.decode(r, r.uint32()));
                    break;
                }
            case 4: {
                    m.providerClientToken = r.bytes();
            ...
            case 8: {
                    if (!(m.deviceCredentials && m.deviceCredentials.length))
                        m.deviceCredentials = [];
                    m.deviceCredentials.push($root.ClientIdentification.ClientCredentials.decode(r, r.uint32()));
                    break;
                }
            default:
                r.skipType(t & 7);
    ...
    ClientIdentification.fromObject = function fromObject(d) {
        if (d instanceof $root.ClientIdentification)
            return d;
        ...
        if (d.clientInfo) {
            ...
            for (var i = 0; i < d.clientInfo.length; ++i) {
                ...
                m.clientInfo[i] = $root.ClientIdentification.NameValue.fromObject(d.clientInfo[i]);
            }
        }
        if (d.providerClientToken != null) {
            if (typeof d.providerClientToken === "string")
        ...
        if (d.clientCapabilities != null) {
            ...
            m.clientCapabilities = $root.ClientIdentification.ClientCapabilities.fromObject(d.clientCapabilities);
        }
        if (d.vmpData != null) {
            if (typeof d.vmpData === "string")
                $util.base64.decode(d.vmpData, m.vmpData = $util.newBuffer($util.base64.length(d.vmpData)), 0);
            else if (d.vmpData.length >= 0)
                m.vmpData = d.vmpData;
        }
        if (d.deviceCredentials) {
            ...
            for (var i = 0; i < d.deviceCredentials.length; ++i) {
                ...
                m.deviceCredentials[i] = $root.ClientIdentification.ClientCredentials.fromObject(d.deviceCredentials[i]);
            }
        }
        return m;
    };
    ...
    ClientIdentification.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if (o.bytes === String)
                ...
                d.vmpData = [];
                if (o.bytes !== Array)
                    d.vmpData = $util.newBuffer(d.vmpData);
            }
        }
        if (m.type != null && m.hasOwnProperty("type")) {
            d.type = o.enums === String ? $root.ClientIdentification.TokenType[m.type] === undefined ? m.type : $root.ClientIdentification.TokenType[m.type] : m.type;
        }
        ...
        if (m.clientInfo && m.clientInfo.length) {
            ...
            for (var j = 0; j < m.clientInfo.length; ++j) {
                d.clientInfo[j] = $root.ClientIdentification.NameValue.toObject(m.clientInfo[j], o);
            }
        }
        if (m.providerClientToken != null && m.hasOwnProperty("providerClientToken")) {
            d.providerClientToken = o.bytes === String ? $util.base64.encode(m.providerClientToken, 0, m.providerClientToken.length) : o.bytes === Array ? Array.prototype.slice.call(m.providerClientToken) : m.providerClientToken;
        ...
        if (m.clientCapabilities != null && m.hasOwnProperty("clientCapabilities")) {
            d.clientCapabilities = $root.ClientIdentification.ClientCapabilities.toObject(m.clientCapabilities, o);
        }
        ...
        if (m.deviceCredentials && m.deviceCredentials.length) {
            ...
            for (var j = 0; j < m.deviceCredentials.length; ++j) {
                d.deviceCredentials[j] = $root.ClientIdentification.ClientCredentials.toObject(m.deviceCredentials[j], o);
            }
        }
        return d;
    };
    ...
    ClientIdentification.NameValue = (function() {
        ...
        NameValue.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.ClientIdentification.NameValue();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        NameValue.fromObject = function fromObject(d) {
            if (d instanceof $root.ClientIdentification.NameValue)
                return d;
    ...
    ClientIdentification.ClientCapabilities = (function() {
        ...
        ClientCapabilities.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.ClientIdentification.ClientCapabilities();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
                ...
                case 9: {
                        ...
                        if ((t & 7) === 2) {
                            ...
                            while (r.pos < c2)
                                m.supportedCertificateKeyType.push(r.int32());
                        } else
                            m.supportedCertificateKeyType.push(r.int32());
                        break;
                    }
        ...
        ClientCapabilities.fromObject = function fromObject(d) {
            if (d instanceof $root.ClientIdentification.ClientCapabilities)
                return d;
        ...
        ClientCapabilities.toObject = function toObject(m, o) {
            ...
            if (m.maxHdcpVersion != null && m.hasOwnProperty("maxHdcpVersion")) {
                d.maxHdcpVersion = o.enums === String ? $root.ClientIdentification.ClientCapabilities.HdcpVersion[m.maxHdcpVersion] === undefined ? m.maxHdcpVersion : $root.ClientIdentification.ClientCapabilities.HdcpVersion[m.maxHdcpVersion] : m.maxHdcpVersion;
            }
            ...
            if (m.supportedCertificateKeyType && m.supportedCertificateKeyType.length) {
                ...
                for (var j = 0; j < m.supportedCertificateKeyType.length; ++j) {
                    d.supportedCertificateKeyType[j] = o.enums === String ? $root.ClientIdentification.ClientCapabilities.CertificateKeyType[m.supportedCertificateKeyType[j]] === undefined ? m.supportedCertificateKeyType[j] : $root.ClientIdentification.ClientCapabilities.CertificateKeyType[m.supportedCertificateKeyType[j]] : m.supportedCertificateKeyType[j];
                }
            }
            if (m.analogOutputCapabilities != null && m.hasOwnProperty("analogOutputCapabilities")) {
                d.analogOutputCapabilities = o.enums === String ? $root.ClientIdentification.ClientCapabilities.AnalogOutputCapabilities[m.analogOutputCapabilities] === undefined ? m.analogOutputCapabilities : $root.ClientIdentification.ClientCapabilities.AnalogOutputCapabilities[m.analogOutputCapabilities] : m.analogOutputCapabilities;
            }
    ...
    ClientIdentification.ClientCredentials = (function() {
        ...
        ClientCredentials.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.ClientIdentification.ClientCredentials();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        ClientCredentials.fromObject = function fromObject(d) {
            if (d instanceof $root.ClientIdentification.ClientCredentials)
                return d;
...
export const EncryptedClientIdentification = $root.EncryptedClientIdentification = (() => {
    ...
    EncryptedClientIdentification.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.EncryptedClientIdentification();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    EncryptedClientIdentification.fromObject = function fromObject(d) {
        if (d instanceof $root.EncryptedClientIdentification)
            return d;
        ...
        if (d.serviceCertificateSerialNumber != null) {
            if (typeof d.serviceCertificateSerialNumber === "string")
                $util.base64.decode(d.serviceCertificateSerialNumber, m.serviceCertificateSerialNumber = $util.newBuffer($util.base64.length(d.serviceCertificateSerialNumber)), 0);
        ...
        if (d.encryptedClientId != null) {
            if (typeof d.encryptedClientId === "string")
                $util.base64.decode(d.encryptedClientId, m.encryptedClientId = $util.newBuffer($util.base64.length(d.encryptedClientId)), 0);
        ...
        if (d.encryptedClientIdIv != null) {
            if (typeof d.encryptedClientIdIv === "string")
                $util.base64.decode(d.encryptedClientIdIv, m.encryptedClientIdIv = $util.newBuffer($util.base64.length(d.encryptedClientIdIv)), 0);
        ...
        if (d.encryptedPrivacyKey != null) {
            if (typeof d.encryptedPrivacyKey === "string")
                $util.base64.decode(d.encryptedPrivacyKey, m.encryptedPrivacyKey = $util.newBuffer($util.base64.length(d.encryptedPrivacyKey)), 0);
    ...
    EncryptedClientIdentification.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if (o.bytes === String)
                ...
                d.serviceCertificateSerialNumber = [];
                if (o.bytes !== Array)
                    d.serviceCertificateSerialNumber = $util.newBuffer(d.serviceCertificateSerialNumber);
            }
            if (o.bytes === String)
                d.encryptedClientId = "";
            else {
        ...
        if (m.serviceCertificateSerialNumber != null && m.hasOwnProperty("serviceCertificateSerialNumber")) {
            d.serviceCertificateSerialNumber = o.bytes === String ? $util.base64.encode(m.serviceCertificateSerialNumber, 0, m.serviceCertificateSerialNumber.length) : o.bytes === Array ? Array.prototype.slice.call(m.serviceCertificateSerialNumber) : m.serviceCertificateSerialNumber;
        }
        if (m.encryptedClientId != null && m.hasOwnProperty("encryptedClientId")) {
            d.encryptedClientId = o.bytes === String ? $util.base64.encode(m.encryptedClientId, 0, m.encryptedClientId.length) : o.bytes === Array ? Array.prototype.slice.call(m.encryptedClientId) : m.encryptedClientId;
        }
        if (m.encryptedClientIdIv != null && m.hasOwnProperty("encryptedClientIdIv")) {
            d.encryptedClientIdIv = o.bytes === String ? $util.base64.encode(m.encryptedClientIdIv, 0, m.encryptedClientIdIv.length) : o.bytes === Array ? Array.prototype.slice.call(m.encryptedClientIdIv) : m.encryptedClientIdIv;
        }
        if (m.encryptedPrivacyKey != null && m.hasOwnProperty("encryptedPrivacyKey")) {
            d.encryptedPrivacyKey = o.bytes === String ? $util.base64.encode(m.encryptedPrivacyKey, 0, m.encryptedPrivacyKey.length) : o.bytes === Array ? Array.prototype.slice.call(m.encryptedPrivacyKey) : m.encryptedPrivacyKey;
        }
        return d;
    };
...
export const LicenseError = $root.LicenseError = (() => {
    ...
    LicenseError.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.LicenseError();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    LicenseError.fromObject = function fromObject(d) {
        if (d instanceof $root.LicenseError)
            return d;
    ...
    LicenseError.toObject = function toObject(m, o) {
        ...
        if (m.errorCode != null && m.hasOwnProperty("errorCode")) {
            d.errorCode = o.enums === String ? $root.LicenseError.Error[m.errorCode] === undefined ? m.errorCode : $root.LicenseError.Error[m.errorCode] : m.errorCode;
        }
        return d;
    };
...
export const DrmCertificate = $root.DrmCertificate = (() => {
    ...
    DrmCertificate.encode = function encode(m, w) {
        ...
        if (m.encryptionKey != null && Object.hasOwnProperty.call(m, "encryptionKey"))
            $root.DrmCertificate.EncryptionKey.encode(m.encryptionKey, w.uint32(90).fork()).ldelim();
    ...
    DrmCertificate.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.DrmCertificate();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
            ...
            case 11: {
                    m.encryptionKey = $root.DrmCertificate.EncryptionKey.decode(r, r.uint32());
                    break;
                }
            default:
                r.skipType(t & 7);
    ...
    DrmCertificate.fromObject = function fromObject(d) {
        if (d instanceof $root.DrmCertificate)
            return d;
        ...
        if (d.serialNumber != null) {
            if (typeof d.serialNumber === "string")
                $util.base64.decode(d.serialNumber, m.serialNumber = $util.newBuffer($util.base64.length(d.serialNumber)), 0);
            else if (d.serialNumber.length >= 0)
        ...
        if (d.rotId != null) {
            if (typeof d.rotId === "string")
                $util.base64.decode(d.rotId, m.rotId = $util.newBuffer($util.base64.length(d.rotId)), 0);
            else if (d.rotId.length >= 0)
                m.rotId = d.rotId;
        }
        if (d.encryptionKey != null) {
            if (typeof d.encryptionKey !== "object")
                throw TypeError(".DrmCertificate.encryptionKey: object expected");
            m.encryptionKey = $root.DrmCertificate.EncryptionKey.fromObject(d.encryptionKey);
        }
        return m;
    };
    ...
    DrmCertificate.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if (o.bytes === String)
                ...
                d.serialNumber = [];
                if (o.bytes !== Array)
                    d.serialNumber = $util.newBuffer(d.serialNumber);
            }
            ...
            if (o.bytes === String)
                ...
                d.rotId = [];
                if (o.bytes !== Array)
                    d.rotId = $util.newBuffer(d.rotId);
            }
            d.encryptionKey = null;
            d.expirationTimeSeconds = 0;
        }
        if (m.type != null && m.hasOwnProperty("type")) {
            d.type = o.enums === String ? $root.DrmCertificate.Type[m.type] === undefined ? m.type : $root.DrmCertificate.Type[m.type] : m.type;
        }
        ...
        if (m.serviceTypes && m.serviceTypes.length) {
            ...
            for (var j = 0; j < m.serviceTypes.length; ++j) {
                d.serviceTypes[j] = o.enums === String ? $root.DrmCertificate.ServiceType[m.serviceTypes[j]] === undefined ? m.serviceTypes[j] : $root.DrmCertificate.ServiceType[m.serviceTypes[j]] : m.serviceTypes[j];
            }
        }
        if (m.algorithm != null && m.hasOwnProperty("algorithm")) {
            d.algorithm = o.enums === String ? $root.DrmCertificate.Algorithm[m.algorithm] === undefined ? m.algorithm : $root.DrmCertificate.Algorithm[m.algorithm] : m.algorithm;
        }
        ...
        if (m.encryptionKey != null && m.hasOwnProperty("encryptionKey")) {
            d.encryptionKey = $root.DrmCertificate.EncryptionKey.toObject(m.encryptionKey, o);
        }
    ...
    DrmCertificate.EncryptionKey = (function() {
        ...
        EncryptionKey.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.DrmCertificate.EncryptionKey();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        EncryptionKey.fromObject = function fromObject(d) {
            if (d instanceof $root.DrmCertificate.EncryptionKey)
                return d;
...
export const SignedDrmCertificate = $root.SignedDrmCertificate = (() => {
    ...
    SignedDrmCertificate.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.SignedDrmCertificate();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    SignedDrmCertificate.fromObject = function fromObject(d) {
        if (d instanceof $root.SignedDrmCertificate)
            return d;
        var m = new $root.SignedDrmCertificate();
        if (d.drmCertificate != null) {
            if (typeof d.drmCertificate === "string")
                $util.base64.decode(d.drmCertificate, m.drmCertificate = $util.newBuffer($util.base64.length(d.drmCertificate)), 0);
    ...
    SignedDrmCertificate.toObject = function toObject(m, o) {
        ...
        if (m.hashAlgorithm != null && m.hasOwnProperty("hashAlgorithm")) {
            d.hashAlgorithm = o.enums === String ? $root.HashAlgorithmProto[m.hashAlgorithm] === undefined ? m.hashAlgorithm : $root.HashAlgorithmProto[m.hashAlgorithm] : m.hashAlgorithm;
        }
        return d;
    };
...
export const WidevinePsshData = $root.WidevinePsshData = (() => {
    ...
    WidevinePsshData.encode = function encode(m, w) {
        ...
        if (m.entitledKeys != null && m.entitledKeys.length) {
            for (var i = 0; i < m.entitledKeys.length; ++i)
                $root.WidevinePsshData.EntitledKey.encode(m.entitledKeys[i], w.uint32(114).fork()).ldelim();
        }
    ...
    WidevinePsshData.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.WidevinePsshData();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 2: {
            ...
            case 14: {
                    if (!(m.entitledKeys && m.entitledKeys.length))
                        m.entitledKeys = [];
                    m.entitledKeys.push($root.WidevinePsshData.EntitledKey.decode(r, r.uint32()));
                    break;
                }
            case 15: {
     ...
     */
    WidevinePsshData.fromObject = function fromObject(d) {
        if (d instanceof $root.WidevinePsshData)
            return d;
        ...
        if (d.keyIds) {
            ...
            for (var i = 0; i < d.keyIds.length; ++i) {
                if (typeof d.keyIds[i] === "string")
                    $util.base64.decode(d.keyIds[i], m.keyIds[i] = $util.newBuffer($util.base64.length(d.keyIds[i])), 0);
                else if (d.keyIds[i].length >= 0)
                    m.keyIds[i] = d.keyIds[i];
            }
        }
        if (d.contentId != null) {
            if (typeof d.contentId === "string")
                $util.base64.decode(d.contentId, m.contentId = $util.newBuffer($util.base64.length(d.contentId)), 0);
            else if (d.contentId.length >= 0)
                m.contentId = d.contentId;
        }
        ...
        if (d.entitledKeys) {
            ...
            for (var i = 0; i < d.entitledKeys.length; ++i) {
                ...
                m.entitledKeys[i] = $root.WidevinePsshData.EntitledKey.fromObject(d.entitledKeys[i]);
            }
        }
        ...
        if (d.groupedLicense != null) {
            if (typeof d.groupedLicense === "string")
                $util.base64.decode(d.groupedLicense, m.groupedLicense = $util.newBuffer($util.base64.length(d.groupedLicense)), 0);
    ...
    WidevinePsshData.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            ...
            if (o.bytes === String)
                ...
                d.contentId = [];
                if (o.bytes !== Array)
                    d.contentId = $util.newBuffer(d.contentId);
            }
            d.trackType = "";
            d.policy = "";
        ...
        if (m.algorithm != null && m.hasOwnProperty("algorithm")) {
            d.algorithm = o.enums === String ? $root.WidevinePsshData.Algorithm[m.algorithm] === undefined ? m.algorithm : $root.WidevinePsshData.Algorithm[m.algorithm] : m.algorithm;
        }
        if (m.keyIds && m.keyIds.length) {
            d.keyIds = [];
        ...
        if (m.type != null && m.hasOwnProperty("type")) {
            d.type = o.enums === String ? $root.WidevinePsshData.Type[m.type] === undefined ? m.type : $root.WidevinePsshData.Type[m.type] : m.type;
        }
        ...
        if (m.entitledKeys && m.entitledKeys.length) {
            ...
            for (var j = 0; j < m.entitledKeys.length; ++j) {
                d.entitledKeys[j] = $root.WidevinePsshData.EntitledKey.toObject(m.entitledKeys[j], o);
            }
        }
    ...
    WidevinePsshData.EntitledKey = (function() {
        ...
        EntitledKey.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.WidevinePsshData.EntitledKey();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        EntitledKey.fromObject = function fromObject(d) {
            if (d instanceof $root.WidevinePsshData.EntitledKey)
                return d;
            var m = new $root.WidevinePsshData.EntitledKey();
            if (d.entitlementKeyId != null) {
                if (typeof d.entitlementKeyId === "string")
                    $util.base64.decode(d.entitlementKeyId, m.entitlementKeyId = $util.newBuffer($util.base64.length(d.entitlementKeyId)), 0);
        ...
        EntitledKey.toObject = function toObject(m, o) {
            ...
            if (o.defaults) {
                ...
                if (o.bytes === String)
                    ...
                    d.keyId = [];
                    if (o.bytes !== Array)
                        d.keyId = $util.newBuffer(d.keyId);
                }
                if (o.bytes === String)
                    d.key = "";
                else {
            ...
            if (m.entitlementKeyId != null && m.hasOwnProperty("entitlementKeyId")) {
                d.entitlementKeyId = o.bytes === String ? $util.base64.encode(m.entitlementKeyId, 0, m.entitlementKeyId.length) : o.bytes === Array ? Array.prototype.slice.call(m.entitlementKeyId) : m.entitlementKeyId;
            }
...
export const FileHashes = $root.FileHashes = (() => {
    ...
    FileHashes.encode = function encode(m, w) {
        ...
        if (m.signatures != null && m.signatures.length) {
            for (var i = 0; i < m.signatures.length; ++i)
                $root.FileHashes.Signature.encode(m.signatures[i], w.uint32(18).fork()).ldelim();
        }
        return w;
    };
    ...
    FileHashes.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.FileHashes();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
    ...
    FileHashes.fromObject = function fromObject(d) {
        if (d instanceof $root.FileHashes)
            return d;
        var m = new $root.FileHashes();
        if (d.signer != null) {
            if (typeof d.signer === "string")
                $util.base64.decode(d.signer, m.signer = $util.newBuffer($util.base64.length(d.signer)), 0);
            else if (d.signer.length >= 0)
                m.signer = d.signer;
        }
        if (d.signatures) {
            ...
            for (var i = 0; i < d.signatures.length; ++i) {
                ...
                m.signatures[i] = $root.FileHashes.Signature.fromObject(d.signatures[i]);
            }
        }
        return m;
    };
    ...
    FileHashes.toObject = function toObject(m, o) {
        ...
        if (o.defaults) {
            if (o.bytes === String)
                ...
                d.signer = [];
                if (o.bytes !== Array)
                    d.signer = $util.newBuffer(d.signer);
            }
        }
        if (m.signer != null && m.hasOwnProperty("signer")) {
        ...
        if (m.signatures && m.signatures.length) {
            ...
            for (var j = 0; j < m.signatures.length; ++j) {
                d.signatures[j] = $root.FileHashes.Signature.toObject(m.signatures[j], o);
            }
        }
        return d;
    };
    ...
    FileHashes.Signature = (function() {
        ...
        Signature.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.FileHashes.Signature();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1: {
        ...
        Signature.fromObject = function fromObject(d) {
            if (d instanceof $root.FileHashes.Signature)
                return d;
            ...
            if (d.SHA512Hash != null) {
                if (typeof d.SHA512Hash === "string")
                    $util.base64.decode(d.SHA512Hash, m.SHA512Hash = $util.newBuffer($util.base64.length(d.SHA512Hash)), 0);
                else if (d.SHA512Hash.length >= 0)
                    m.SHA512Hash = d.SHA512Hash;
            }
            if (d.mainExe != null) {
        ...
        Signature.toObject = function toObject(m, o) {
            ...
            if (o.defaults) {
                ...
                if (o.bytes === String)
                    ...
                    d.SHA512Hash = [];
                    if (o.bytes !== Array)
                        d.SHA512Hash = $util.newBuffer(d.SHA512Hash);
                }
                d.mainExe = false;
                if (o.bytes === String)
                    d.signature = "";
...
export const RemoteAttestation = $root.RemoteAttestation = (() => {
    ...
    RemoteAttestation.encode = function encode(m, w) {
        ...
        if (m.certificate != null && Object.hasOwnProperty.call(m, "certificate"))
            $root.EncryptedClientIdentification.encode(m.certificate, w.uint32(10).fork()).ldelim();
     ...
     * @returns {$protobuf.Writer} Writer
     */
    RemoteAttestation.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
    ...
    RemoteAttestation.decode = function decode(r, l) {
        if (!(r instanceof $Reader))
            r = $Reader.create(r);
        var c = l === undefined ? r.len : r.pos + l, m = new $root.RemoteAttestation();
        while (r.pos < c) {
            var t = r.uint32();
            switch (t >>> 3) {
            case 1: {
                    m.certificate = $root.EncryptedClientIdentification.decode(r, r.uint32());
                    break;
                }
            case 2: {
                    m.salt = r.bytes();
    ...
    RemoteAttestation.fromObject = function fromObject(d) {
        if (d instanceof $root.RemoteAttestation)
            return d;
        ...
        if (d.certificate != null) {
            ...
            m.certificate = $root.EncryptedClientIdentification.fromObject(d.certificate);
        }
        if (d.salt != null) {
    ...
    RemoteAttestation.toObject = function toObject(m, o) {
        ...
        if (m.certificate != null && m.hasOwnProperty("certificate")) {
            d.certificate = $root.EncryptedClientIdentification.toObject(m.certificate, o);
        }
